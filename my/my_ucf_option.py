...
parser.add_argument('--train-list', default='list/new_ucf_CLIP_rgb.csv')
parser.add_argument('--test-list', default='my/my_ucf_CLIP_rgbtest.csv')
parser.add_argument('--gt-path', default='my/my_gt_ucf.npy')
parser.add_argument('--gt-segment-path', default='my/my_gt_segment_ucf.npy')
parser.add_argument('--gt-label-path', default='my/my_gt_label_ucf.npy')
